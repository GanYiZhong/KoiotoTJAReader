...
## ⚠️ Koioto 公式規定に関する重要な声明

**Koioto の公式ガイドラインに従い:** Koioto で再生される「既存の商用ゲーム楽曲の譜面」に関するビデオやスクリーンショットの公開は厳禁です。

本プラグインは、個人が作成した譜面、または適切な許可を得た譜面の読み取りのみを目的としています。ユーザーは Koioto の利用規約を遵守し、本プラグインを著作権侵害コンテンツの公開に使用してはいけません。
